    ...
    return (
        <>  { visible ? (
            ...
            >
                ...
                <div className="bg-mobile_two bg-contain bg-no-repeat border-2 rounded-md border-gray-600 h-30long md:h-51.6long w-13.9long md:w-23.9long" />
                ...
                <div className="p-3 flex flex-col justify-center items-center border-2 rounded-md border-gray-600 bg-blue-100 shadow-xl">
                    ...
                    <p className="p-1 font-title bg-gray-500 hover:bg-gray-600 active:bg-gray-700 text-gray-200 text-center font-medium w-11long">
                        <a href={portfolioPageContents.m2Link} rel="noreferrer" target="_blank">
                            {portfolioPageContents.portfolioTextMobile1.subtitleP3_2}
                        </a>
                    </p>
