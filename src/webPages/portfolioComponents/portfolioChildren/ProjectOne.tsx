    ...
    return (
        <> {
            ...
            >
                ...
                <div className="bg-project-one bg-cover bg-no-repeat border-2 rounded-md border-gray-600 h-11.2long md:h-23.5long lg:h-26.9long w-18long md:w-38long lg:w-43.5long" />
