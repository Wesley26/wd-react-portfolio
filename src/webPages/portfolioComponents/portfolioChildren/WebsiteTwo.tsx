    ...
    return (
        <>  { visible ? (
            ...
            >
                ...
                <div className="bg-website_two bg-cover bg-no-repeat border-2 rounded-md border-gray-600 h-11.2long md:h-23.5long lg:h-26.9long w-18long md:w-38long lg:w-43.5long" />
                ...
                <div className="p-3 flex flex-col justify-center items-center border-2 rounded-md border-gray-600 bg-blue-100 shadow-xl">
                    ...
                    <p className="p-1 font-title bg-gray-500 text-gray-200 text-center font-medium w-11long">
                        {portfolioPageContents.portfolioTextWeb1.titleP2}
                    </p>
                    ...
                    <p className="p-1 font-title bg-gray-500 hover:bg-gray-600 active:bg-gray-700 text-gray-200 text-center font-medium w-11long">
                        <a href={portfolioPageContents.w2Link} rel="noreferrer" target="_blank">
                            {portfolioPageContents.portfolioTextWeb1.subtitleP1_2}
                        </a>
                    </p>
